...
public abstract class AbsSpinner extends AdapterView<SpinnerAdapter> {
    ...
    public AbsSpinner(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArrayWarpper a = new TypedArrayWarpper(context.obtainStyledAttributes(attrs,
                getStyleableValues("AbsSpinner"), defStyle, 0));

        CharSequence[] entries = a.getTextArray(ABSSPINNER_ENTRIES);
        if (entries != null) {
    ...
    public void setAdapter(SpinnerAdapter adapter) {
        ...
        if (mAdapter != null) {
            ...
            mDataSetObserver = createObserver();
    ...
    protected com.tencent.widget.AdapterView.AdapterDataSetObserver createObserver() {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        heightSize = doResolveSizeAndState(preferredHeight, heightMeasureSpec, 0);
        widthSize = doResolveSizeAndState(preferredWidth, widthMeasureSpec, 0);
     ...
     */
    private int doResolveSizeAndState(int size, int measureSpec, int childMeasuredState) {
        int result = size;
