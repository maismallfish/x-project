...
public class LoginActivity extends Activity {
	 ...
	 */
	public static final String EXTRA_PHONE = "com.example.android.authenticatordemo.extra.LoginPhone";
	...
	private Button mBtnAuthGetCode;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mPhone = getIntent().getStringExtra(common.EXTRA_USERID);
		mEdtPhone = (EditText) findViewById(R.id.edt_phone);
		mEdtPhone.setText(mPhone);

		mEdtAuthCode = (EditText) findViewById(R.id.btn_getCode);
	}
	 ...
	 */
	static public void attemptLogin(UserStruct user) {
